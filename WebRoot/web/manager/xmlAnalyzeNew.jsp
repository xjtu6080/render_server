					...
					<div class="ui-form-sitefont">
						<form id="newCalculate-form" action="doNewCalculate.action" method="post">
							...
							<fieldset>
								...
								<%-- <p class="form-field">
									<label class="input-label" for="calculate_job_id">所属作业名:</label>		
									<div id="selectJobInfo" style="display:block">								
										<select name="calculate_job_id" id="calculate_job_id" datatype="*" nullmsg="请选择作业！" sucmsg="&nbsp;">
											<option value="">--请选择作业--</option>
										</select>	
									</div>	
									
									<div id="loadingJob" style="display:none">
										<img alt="" src="images/loading.gif" width="28px" height="28px" />正在加载中......
									</div>				
								</p> --%>

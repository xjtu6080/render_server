...
(function(b) {
    b.fn.bPopup = function(n, p) {
        ...
        function o() {
            a.modal && b(".bModal." + c.data("id")).fadeOut(a.fadeSpeed,
            function() {
                b(this).remove()
            });
            c.stop().fadeOut(a.fadeSpeed,
            function() {
        ...
        function u() {
            ...
            function() {
                if (q = s()) j = r(c, a.amsl),
                a.follow[0] && (g = m ? g: j[0]),
                a.follow[1] && (f = l ? f: j[1]),
                c.stop().each(function() {
                    i ? b(this).css({
                        left: g,
                        top: f
                    },
